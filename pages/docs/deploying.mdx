...
The format of how to list out services is similar to how Docker Compose v1 files are. You only need to list out the services and the directives in it. Most Docker Compose v1 and v2 fields will work as expected in Deviceplane, but there are some specific fields that will behave differently in Deviceplane.
