...
curl --retry 10 --retry-delay 60 --retry-connrefused https://downloads.deviceplane.com/install.sh | PROJECT=$YOUR_PROJECT REGISTRATION_TOKEN=$YOUR_REGISTRATION_TOKEN bash
