...
Now that we have an empty project, our next step is to add a device. From the "Devices" page click on "Add Device". A Docker command will be generated. Running this command on your device will download our agent image and then start the agent as a new container.
