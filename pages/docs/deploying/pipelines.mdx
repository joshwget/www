...
After such a pipeline is setup developers can simply `git push` and have their application update across their devices. [Release pinning](/docs/deploying/release-pinning) can be used in conjunction with pipelines to safely rollout changes after the release is created.
