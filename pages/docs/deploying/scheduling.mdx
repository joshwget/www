...
The first two are easy to use. However the third option, conditional scheduling, gives you much more control over which devices an application can be scheduled to.
...
During this example, we'll talk about filters, in the context of scheduling rules. If you'd like to find more detailed documentation on them, you can [find a reference here](/docs/deploying/filters).
